...
const ErrorNotification = ({ duration, message }) => {
    ...
    return (
        <div className="fixed bottom-4 right-4 p-4 w-[400px] bg-red-900 text-white rounded-lg shadow-lg">
...
const SuccessNotification = ({ duration, message }) => {
    ...
    return (
        <div className="fixed bottom-4 right-4 p-4 w-[400px] bg-green-900 text-white rounded-lg shadow-lg">
